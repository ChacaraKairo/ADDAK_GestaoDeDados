...
char Validacao_De_Usuario(){
 ...
 // Executar a consulta SQL
   ...
   if (mysql_query(obj, consulta)) {
    ...
    const char* senhaDB = to_string(row[0]).c_str();
    ...
    cout << "Senha: ";
    cin >> senha;
//A função strcmp é uma função da linguagem de programação C, e ela é usada para comparar duas strings, ela vem da <cstring>
